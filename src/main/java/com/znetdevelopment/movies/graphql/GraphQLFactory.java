package com.znetdevelopment.movies.graphql;
...
public class GraphQLFactory {
    ...
    @Inject private List<DataFetchers> dataFetchers;
    ...
    public GraphQL graphQL() {
        ...
        dataFetchers.forEach(dataFetcher -> {
            for (Method method : dataFetcher.getClass().getMethods()) {
                ...
                // lookup the name of the property on the parent type or default to the name of the method
                ...
                wiring.type(parentType, typeWiring -> {
                    typeWiring.dataFetcher(_property, (env) -> {
                        ...
                        try { return convert(method.invoke(dataFetcher, args)); }
    ...
    public static Object convert(Object value) {
        ...
        else if (value instanceof Single) { return fromSingle((Single) value); }
        else { return value; }
    }
